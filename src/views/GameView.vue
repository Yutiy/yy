...
import { basicCannon, schoolPride, fireworks } from '../core/utils'
...
<template>
  <div flex flex-col w-full h-full>
    ...
    <div w-full flex items-center justify-center>
      <div border="~ 4px dashed #000" w-295px h-50px flex>
    ...
    <div w-full color="#000" fw-600 flex items-center justify-center pb-10px>
      <span mr-20px>designer: xxx</span>
      <span>by: Yutiy</span>
      <a
        class="icon-btn"
        color="#000"
